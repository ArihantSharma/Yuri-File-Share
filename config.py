...
#start message
START_MSG = os.environ.get("START_MESSAGE", "ʏᴏᴏ {mention}, 🥳/nꜱᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴡɪᴛʜ ᴛʜᴇ ʟɪɴᴋꜱ ᴘʀᴏᴠɪᴅᴇᴅ ɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ.")
try:
    ADMINS=[]
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "<pre>ʏᴏᴜ ᴇxᴘᴇᴄᴛ ᴛᴏ ᴜꜱᴇ ᴍᴇ, ᴡɪᴛʜᴏᴜᴛ ᴇᴠᴇɴ ᴊᴏɪɴɪɴɢ ᴍʏ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ? 😔</pre>")
...
USER_REPLY_TEXT = "<pre>ᴅᴏɴ'ᴛ ᴍᴇꜱꜱᴀɢᴇ ᴍᴇ, ɪ'ᴍ ʟᴏʏᴀʟ ᴛᴏ ᴍʏ ᴀᴅᴍɪɴꜱ 😤</pre>"
